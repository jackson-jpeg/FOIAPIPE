...
export const INCIDENT_TYPES = {
  ...
  arrest: { label: 'Arrest', color: '#06b6d4', variant: 'info' },
  dui: { label: 'DUI', color: '#06b6d4', variant: 'info' },
...
export const FOIA_STATUSES: Record<string, { label: string; color: string; variant: string }> = {
  ...
  submitted: { label: 'Submitted', color: '#06b6d4', variant: 'info' },
...
export const VIDEO_STATUSES: Record<string, { label: string; color: string; variant: string }> = {
  ...
  ready: { label: 'Ready', color: '#06b6d4', variant: 'info' },
