        ...
        <table className="w-full">
          <thead className="bg-surface-tertiary/50 sticky top-0 z-10">
            <tr>
              ...
              <th className="px-4 py-4 text-left text-xs font-medium uppercase tracking-wider text-text-tertiary hidden lg:table-cell">Incident</th>
              ...
              <th className="px-4 py-4 text-left text-xs font-medium uppercase tracking-wider text-text-tertiary hidden md:table-cell">Cost</th>
              <th className="px-4 py-4 text-left text-xs font-medium uppercase tracking-wider text-text-tertiary hidden md:table-cell">Priority</th>
          ...
          <tbody>
            {Array.from({ length: 6 }).map((_, i) => (
              <tr key={i} className="border-b border-surface-border/30">
                ...
                <td className="px-4 py-4"><div className="shimmer h-3.5 w-24 rounded" /></td>
                <td className="px-4 py-4 hidden md:table-cell"><div className="shimmer h-3.5 w-16 rounded" /></td>
                <td className="px-4 py-4 hidden md:table-cell"><div className="flex gap-0.5"><div className="shimmer h-3 w-3 rounded-full" /><div className="shimmer h-3 w-3 rounded-full" /><div className="shimmer h-3 w-3 rounded-full" /></div></td>
      ...
      <table className="w-full">
        <thead className="bg-surface-tertiary/50 sticky top-0 z-10">
          <tr>
            ...
            <th className="px-3 py-2.5 text-left text-2xs font-medium text-text-tertiary hidden lg:table-cell">Incident</th>
            <SortHeader label="Status" field="status" />
            <SortHeader label="Submitted" field="submitted_at" />
            <SortHeader label="Due Date" field="due_date" />
            <th className="px-3 py-2.5 text-left text-2xs font-medium text-text-tertiary hidden md:table-cell">Cost</th>
            <th className="px-3 py-2.5 text-left text-2xs font-medium text-text-tertiary hidden md:table-cell">Priority</th>
